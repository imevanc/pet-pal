...
const EditProfilePage: React.FC = () => {
  return (
    <div className="sm:mx-auto max-w-3xl sm:my-4 mx-4">
      <div className="lg:grid lg:grid-cols-12 lg:gap-x-5 bg-gray-50">
                ...
                <div className="grid grid-cols-3 gap-6">
                  <div className="col-span-3 sm:col-span-2">
                    ...
                    <div className="mt-1 flex rounded-md shadow-sm">
                      ...
                      <input
                        ...
                        className="block w-full min-w-0 flex-grow rounded-none rounded-r-md border-gray-300 focus:border-lime-500 focus:ring-lime-500 sm:text-sm"
                      />
                    </div>
                  </div>
                  ...
                  <div className="col-span-3">
                    ...
                    <div className="mt-1 flex items-center">
                      ...
                      <button
                        type="button"
                        className="ml-5 rounded-md border border-gray-300 bg-white py-2 px-3 text-sm font-medium leading-4 text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-lime-500 focus:ring-offset-2"
                      >
                        Change
                      </button>
                    </div>
