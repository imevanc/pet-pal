  ...
  return (
    <div className="prose prose-lg prose-lime mx-auto mt-10 text-gray-500">
      ...
      <p>
        ...
        video content) voluntarily supplied to us by our users for the purpose
        of publication on our website or re-publishing on our social media
        channels. All user-generated content is associated with the account or
      ...
      <ul role="list">
        ...
        <li>
          to enable you to customize or personalise your experience of our
          website
        </li>
        ...
        <li>
          to attribute any content (e.g. posts and comments) you submit that we
      ...
      <p>
        ...
        activities may uncover data and insights, which we may combine with
      ...
      <ul role="list">
        ...
        <li>
          ...
          problem-solving providers, advertising providers, professional
      ...
      <p>
        ...
        Kingdom, and United States, or where we or our partners, affiliates, and
      ...
      <p>
        ...
        offer (for example providing user support), we will not deny you goods
        or services and/or charge you different prices or rates for goods or
        services, including through granting discounts or other benefits, or
        imposing penalties, or provide you with a different level or quality of
        goods or services.
      </p>
      <p>
        Notification of data breaches: We will comply with laws applicable to us
      ...
      <p>
        ...
        using the details provided in this privacy policy, or opt-out using the
        opt-out facilities provided in the communication. We may need to request
      ...
      <p>
        ...
        organizations (known as “data processors”). We, Pet-Pal, located at the
        address provided in our Contact Us section, are a Data Controller and/or
        Processor with respect to the personal information you provide to us.
      </p>
      ...
      <p>
        ...
        personal information lawfully, fairly and in a transparent manner. If we
        seek your consent to process your personal information, and you are
      ...
      <p>
        ...
        information that has already taken place. When you contact us, you may
        consent to your name and email address being used so we can respond to
        your enquiry. While you may request that we delete your contact details
        at any time, we cannot recall any email we have already sent. If you
      ...
      <p>
        ...
        transaction with you. For example, if you contact us with an enquiry, we
        may require personal information such as your name and contact details
        in order to respond.
      </p>
      ...
      <h3>Your Rights and Controlling Your Personal Information</h3>
      <p>
        Restrict: You have the right to request that we restrict the processing
        of your personal information if (i) you are concerned about the accuracy
        of your personal information; (ii) you believe your personal information
        has been unlawfully processed; (iii) you need us to maintain the
        personal information solely for the purpose of a legal claim; or (iv) we
        are in the process of considering your objection in relation to
        processing on the basis of legitimate interests.
      </p>
      <p>
        Objecting to processing: You have the right to object to processing of
      ...
      <p>
        Data portability: You may have the right to request a copy of the
        ...
        You may also have the right to request that we transfer this personal
        information to a third party.
      </p>
      <p>
        Deletion: You may have a right to request that we delete the personal
        ...
        you ask us to delete your personal information, we will let you know how
        the deletion affects your use of our website or products and services.
        There may be exceptions to this right for specific legal reasons which,
        if applicable, we will set out for you in response to your request. If
        you terminate or delete your account, we will delete your personal
        information within 30 days of the deletion of your account. Please be
        aware that search engines and similar third parties may still retain
        copies of your personal information that has been made public at least
        once, like certain profile information and public comments, even after
        you have deleted the information from our services or deactivated your
        account.
      </p>
      ...
      <p>
        ...
        revealed to other organisations for their marketing purposes in the last
      ...
      <p>
        ...
        We collect and use these categories of personal information for the
        business purposes described in the “Collection and Use of Information”
      ...
      <p>
        ...
        Privacy Rights Request” in the first line of the description and include
      ...
      <h4>pet-pal.vercel.app — Contact</h4>
    </div>
  );
};
